...
export default function Page() {
  return (
    <>
    <div className="min-h-screen w-full rounded-md bg-gray-900 relative flex flex-col items-center justify-center antialiased py-12 pt-24">
      <div className="max-w-2xl mx-auto p-4 flex flex-col items-center justify-center">
        ...
        <input
          ...
          className="rounded-lg border border-neutral-800 focus:ring-2 focus:ring-teal-500  w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral- px-2 py-3 text-xl text-white"
        />
        <textarea placeholder="Your Message" className="rounded-lg border border-neutral-800 focus:ring-2 focus:ring-teal-500  w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral- px-2 py-3 text-xl text-white"/>
